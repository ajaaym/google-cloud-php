...
use Google\Cloud\Bigtable\V2\Mutation as ProtoMutation;
...
class Mutation
{
     ...
     *
     * @return Mutation returns current Mutation object.
     */
    public function upsert($family, $qualifier, $value, $timeStamp = null)
    {
        ...
        $this->mutations[] = (new ProtoMutation)->setSetCell($mutationSetCell);
        return $this;
    }
    ...
    {
        $this->mutations[] = (new ProtoMutation)
            ->setDeleteFromFamily(
    ...
    public function deleteFromColumn($family, $qualifier, array $timeRange = [])
    {
        ...
        $this->mutations[] = (new ProtoMutation)->setDeleteFromColumn($deleteFromColumn);
        return $this;
    }
    ...
    {
        $this->mutations[] = (new ProtoMutation)->setDeleteFromRow(new DeleteFromRow);
        return $this;
    }

    /**
     * Returns protobuf Mutation.
     *
     * @return array returns array of protobuf representation of Mutation.
     */
